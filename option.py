...
# Network settings
parser.add_argument('--n_E_HCM', type=int, default=4, help='number of  E_HCMs')
parser.add_argument('--n_feats', type=int, default=64, help='number of feature maps')
parser.add_argument('--n_colors', type=int, default=31, help='number of band')
parser.add_argument('--n_twoUint', type=int, default=2, help='number of two unit')

# Test image
parser.add_argument('--model_name', default='checkpoint/CAVE_model_4_epoch_200.pth', type=str, help='super resolution model name ')
parser.add_argument('--method', default='ERCSR', type=str, help='super resolution method name')
